...
exports.runBuild = (() => {var _ref9 = _asyncToGenerator(function* (_ref10)
  ...
  {let config = _ref10.config;var _ref10$dev = _ref10.dev;let dev = _ref10$dev === undefined ? false : _ref10$dev,entry = _ref10.entry,onBegin = _ref10.onBegin,onComplete = _ref10.onComplete,onProgress = _ref10.onProgress;var _ref10$minify = _ref10.minify;let minify = _ref10$minify === undefined ? true : _ref10$minify;var _ref10$output = _ref10.output;let output = _ref10$output === undefined ? outputBundle : _ref10$output,out = _ref10.out;var _ref10$platform = _ref10.platform;let platform = _ref10$platform === undefined ? `web` : _ref10$platform;var _ref10$sourceMap = _ref10.sourceMap;let sourceMap = _ref10$sourceMap === undefined ? false : _ref10$sourceMap,sourceMapUrl = _ref10.sourceMapUrl,rest = _objectWithoutProperties(_ref10, ['config', 'dev', 'entry', 'onBegin', 'onComplete', 'onProgress', 'minify', 'output', 'out', 'platform', 'sourceMap', 'sourceMapUrl']);
    const metroServer = yield runMetro(_extends({},
    rest, {
      config }));
